...
class Nav extends \yii\bootstrap\Widget
{
     ...
     * @since 2.0.7
     */
    public $dropdownClass = 'loutrux\argon\widgets\Dropdown';
    ...
    public function renderItem($item)
    {
        ...
        /** For Argon Dashboard */
        if (isset($options['class'])) $options['class'] .= ' nav-item';
        else $options['class'] = 'nav-item';
        ...
        /** For Argon Dashboard */
        if (isset($linkOptions['class'])) $linkOptions['class'] .= ' nav-link';
        else $linkOptions['class'] = 'nav-link';
        ...
        if (empty($items)) {
            ...
            if (strtoupper(substr($label,1,3)) !== 'DIV')
