...
<?php $this->beginBody() ?>
    ...
    // In mobile view the second Navbar is hidden and the sideleft menu collapse exept the brandLabel and headerContent

    // This Nav is showed in the header of the sideleft Nabar but hidden in destop view 
    $avatar =   '<div class="media align-items-center">
    ...
    $itemsUser =  [
        ...
        'items' => [
                ['label' => 'Level 1 - Dropdown A', 'url' => '#','linkOptions' => ['class' => 'nav-link text-black']],
                '<hr class="my-3">',
                '<li class="dropdown-header text-gray">Dropdown Header</li>',
                ['label' => 'Level 1 - Dropdown B', 'url' => '#','linkOptions' => ['class' => 'nav-link text-black']],
        ],
    ]];
    $navUser = Nav::widget([
    ...
    NavBar::begin([
        ...
        'headerContent' => $navUser,
    ]);
    $menuItems = [
        ['label' => '<i class="ni ni-tv-2 text-primary"></i> Home', 'url' => ['/site/index'],'linkOptions' => ['class' => 'nav-link'],'options' => ['class' => 'nav-item']],
        ['label' => '<i class="ni ni-tv-2 text-orange"></i> Lapin', 'url' => ['/site/index'],'linkOptions' => ['class' => 'nav-link'],'options' => ['class' => 'nav-item']],
        ['label' => '<i class="ni ni-tv-2 text-yellow"></i> Loutre', 'url' => ['/site/index'],'linkOptions' => ['class' => 'nav-link'],'options' => ['class' => 'nav-item']],
        ['label' => '<i class="ni ni-tv-2 text-green"></i> Cochon', 'url' => ['/site/index'],'linkOptions' => ['class' => 'nav-link'],'options' => ['class' => 'nav-item']],
        ['label' => '<i class="ni ni-tv-2 text-green"></i> About', 'url' => ['/site/about']],
        ['label' => '<i class="ni ni-tv-2 text-green"></i> Contact', 'url' => ['/site/contact']],
        '<hr class="my-3">',
        '<li class="dropdown-header text-gray">Dropdown Header</li>',
        [
            'label' => 'Dropdown',
